...
> [!WARNING]
> Данная интеграция предназначена для работы с устройствами Hommyn в которых через настройки в официальнои приложении указан кастомный MQTT сервер!
> Если вы перенаправляете трафик с адресов `mqtt.cloud.polaris-iot.com` и `mqtt.cloud.rusklimat.ru` на свой MQTT сервер, то вам нужно использовать другую интеграцию: [polaris-mqtt](https://github.com/samoswall/polaris-mqtt)
